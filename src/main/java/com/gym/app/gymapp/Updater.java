...
public class Updater {
    ...
    private static final String DOWNLOAD_URL = "https://github.com/FabianJimenez29/Gym-App/releases/download/V1.4/GymApp-1.0-SNAPSHOT-jar-with-dependencies.jar";
    private static final String NEW_JAR_NAME = "GymApp-1.0-SNAPSHOT-jar-with-dependencies.jar";
    private static final String VERSION_LOCAL = "V1.4"; // 
